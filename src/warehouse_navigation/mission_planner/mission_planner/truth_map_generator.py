...
if __name__ == "__main__":
    ...
    save_map(field_img, "src/warehouse_navigation/mission_planner/config/maps/test_field.png")
    ...
    save_map(distance_field, "src/warehouse_navigation/mission_planner/config/maps/distance_test_field.png")
